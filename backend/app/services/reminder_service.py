        ...
        if "visit" in description:
            ...
            if is_today:
                body = (
                    ...
                    f"We hope this email finds you well.<br><br>"
                    f"This is a gentle reminder regarding the campus visit from {company} scheduled for today. "
                    f"We are looking forward to welcoming your team and have made all necessary arrangements for a productive session.<br><br>"
                    ...
                    f"We believe this collaboration will be mutually beneficial for both {company} and our graduating students.<br><br>"
                    f"Thank you for your continued partnership with our institution.<br><br>"
                    f"Best regards,<br>"
                    f"Placement Team"
                )
            elif is_overdue:
                body = (
                    ...
                    f"We understand that business priorities can sometimes require schedule adjustments.<br><br>"
                    f"We remain enthusiastic about the opportunity to collaborate with {company} and showcase our talented students. "
                    f"Our placement team is flexible and ready to accommodate a revised timeline that works best for your organization.<br><br>"
                    f"We look forward to hearing from you at your convenience.<br><br>"
                    f"Best regards,<br>"
                    f"Placement Team"
                )
            else:
                body = (
                    f"I hope you are doing well.<br><br>"
                    f"This is a gentle reminder regarding {company}'s upcoming campus visit scheduled for {due_date}. "
                    f"We are looking forward to welcoming your team and facilitating meaningful interactions with our students.<br><br>"
                    f"Our placement team is making the necessary preparations to ensure a smooth and productive visit. "
                    f"We are confident that the session will be valuable and beneficial for both sides.<br><br>"
            ...
            body = (
                ...
                f"As mentioned, we were expecting to receive the detailed job description by {due_date}.<br><br>"
                f"To proceed with candidate shortlisting, we would need:<br>"
                f"• Complete job description with role responsibilities<br>"
                f"• Required technical skills and experience level<br>"
                f"• Preferred educational background and CGPA criteria<br><br>"
                f"Once we receive these details, we can immediately start the screening process and share suitable profiles.<br><br>"
                f"Best regards,<br>"
                f"Placement Team"
            )
            ...
            body = (
                ...
                f"We want to ensure we provide you with the most suitable candidates for your requirements.<br><br>"
                f"Could you please confirm:<br>"
                f"• The number of profiles you would like to review<br>"
                f"• Any specific filtering criteria or preferences<br>"
                f"• Your preferred format for receiving the profiles<br><br>"
                f"We have a pool of talented students ready for placement and look forward to your feedback.<br><br>"
                f"Best regards,<br>"
                f"Placement Team"
            )
            ...
            body = (
                ...
                f"We want to ensure smooth coordination for the selection process.<br><br>"
                f"Please let us know:<br>"
                f"• Your preferred interview dates and time slots<br>"
                f"• Interview format (online/offline) and platform details<br>"
                f"• Number of rounds and expected duration<br><br>"
                f"We will coordinate with the shortlisted students and ensure their availability as per your schedule.<br><br>"
                f"Best regards,<br>"
                f"Placement Team"
            )
            ...
            body = (
                ...
                f"To proceed with the placement process, we need the necessary paperwork completed.<br><br>"
                f"Could you please provide an update on:<br>"
                f"• Status of the required documents<br>"
                f"• Any additional information needed from our end<br>"
                f"• Expected timeline for completion<br><br>"
                f"We appreciate your cooperation and look forward to moving forward with the placement process.<br><br>"
                f"Best regards,<br>"
                f"Placement Team"
            )
        else:
            ...
            body = (
                f"Dear {contact_name},<br><br>"
                f"We hope this email finds you well.<br><br>"
                f"This is a follow-up regarding: {reminder.description}.<br>"
                f"The expected timeline was: {due_date}.<br><br>"
                f"Could you please provide an update on:<br>"
                f"• Current status of this commitment<br>"
                f"• Any changes to the original timeline<br>"
                f"• Support needed from our placement team<br><br>"
                f"We value our partnership with {company} and look forward to your response.<br><br>"
                f"Best regards,<br>"
                f"Placement Team"
            )
