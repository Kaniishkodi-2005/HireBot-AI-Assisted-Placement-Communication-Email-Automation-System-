                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex bg-slate-100 rounded-lg p-1">
                        <button
                          ...
                          style={deptFilter === 'all' ? { background: 'linear-gradient(135deg, #6B64F2 0%, #8E5BF6 50%, #A656F7 100%)' } : {}}
                        >
                          All
                        </button>
                        <button
                          ...
                          style={deptFilter === 'software' ? { background: 'linear-gradient(135deg, #6B64F2 0%, #8E5BF6 50%, #A656F7 100%)' } : {}}
                        >
                          Software
                        </button>
                        <button
                          ...
                          style={deptFilter === 'core' ? { background: 'linear-gradient(135deg, #6B64F2 0%, #8E5BF6 50%, #A656F7 100%)' } : {}}
                        >
                          Core
                        </button>
                      </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="pl-10 pr-4 py-2 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 w-64"
                      />
                    </div>
                    {/* Department Filter */}
                    <div className="flex bg-slate-100 rounded-lg p-1">
                      <button
                        ...
                        style={allStudentsDeptFilter === 'all' ? { background: 'linear-gradient(135deg, #6B64F2 0%, #8E5BF6 50%, #A656F7 100%)' } : {}}
                      >
                        All
                      </button>
                      <button
                        ...
                        style={allStudentsDeptFilter === 'software' ? { background: 'linear-gradient(135deg, #6B64F2 0%, #8E5BF6 50%, #A656F7 100%)' } : {}}
                      >
                        Software
                      </button>
                      <button
                        ...
                        style={allStudentsDeptFilter === 'core' ? { background: 'linear-gradient(135deg, #6B64F2 0%, #8E5BF6 50%, #A656F7 100%)' } : {}}
                      >
                        Core
                      </button>
                    </div>
                        ...
                        paginatedStudents.map((s) => (
                          <tr key={s.id} className="hover:bg-slate-50 transition-colors group">
                            ...
                            <td className="px-6 py-4 text-left align-middle">
                              <span className="font-mono text-xs text-emerald-700 bg-emerald-50 px-2 py-1 rounded-full border border-emerald-100 inline-block max-w-[300px] truncate align-middle" title={s.skills_text}>
                                {s.skills_text || "-"}
                              </span>
                            </td>
                          </tr>
